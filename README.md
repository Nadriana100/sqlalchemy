To create a DataFrame for every table in a Database:
...
pytz looks like the slickest solution imho:
...
Once you have that app.py running, try doing this from a new file/notebook:

import requests
print(requests.get("localhost:5000/api/v1.0/names").json())
